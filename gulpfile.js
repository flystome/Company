...
gulp.task('css', ['clean:css'], function(){
	return gulp.src(env.dev + 'static/css/*.css')
	.pipe(gulp.dest(env.test + 'static/css/'));
})

gulp.task("js", ['clean:js'], function(){
	return gulp.src(env.dev + 'static/js/*.js')
	.pipe(gulp.dest(env.test + 'static/js/'));
});
...
gulp.task('build', ['script', 'tmpl', 'less', 'assets','static'])
